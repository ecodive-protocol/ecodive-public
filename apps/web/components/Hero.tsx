    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
          ...
          <a
            href="https://github.com/ecodive-protocol/ecodive-public/raw/main/docs/whitepaper.pdf"
            target="_blank"
            rel="noopener noreferrer"
            download
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-cyan-400/25 text-cyan-200 hover:bg-cyan-400/10 hover:-translate-y-0.5 bg-transparent px-8 py-3.5 transition-all text-sm font-medium"
          >
